...
ALMBpawnBase::ALMBpawnBase()
{
	...
	PawnMovement->Acceleration = 10000.0f; // 얼마나 빠르게 속도가 증가할 지
	PawnMovement->Deceleration = 10000.0f; // 얼마나 빠르게 감속할 지 
    ...
    SpringArmComp->SetRelativeRotation(FRotator(-33.f, 0.f, 0.f));
